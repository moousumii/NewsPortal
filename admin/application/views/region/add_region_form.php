        ...
        <table>
            <tbody>
                    <tr>
                        ...
                        <td><input type='text' class="text ui-widget-content ui-corner-all width_200  required" name='name'  value="<?= set_value('name',$region_data['name']) ?>" /><?= form_error('name', '<span>', '</span>') ?></td>
                    </tr>
